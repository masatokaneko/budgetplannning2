...
import { DetailedReportContent } from "@/components/detailed-report-content"
  ...
  return (
    <SidebarProvider>
      <div className="flex min-h-screen w-full">
        <Sidebar className="border-r border-gray-200 print:hidden">
        ...
        <SidebarInset className="flex flex-1 flex-col">
          {/* Header */}
          <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6 print:hidden">
          ...
          {/* Main Content */}
          <main className="flex-1 bg-gray-50 p-6 print:bg-white print:p-4">
            <div className="mx-auto max-w-7xl print:max-w-none">
              {/* Breadcrumb */}
              <nav className="mb-6 flex items-center space-x-2 text-sm text-gray-500 print:hidden">
                <a href="/" className="hover:text-gray-700">
                  ホーム
                </a>
                <span>/</span>
                <a href="/analysis" className="hover:text-gray-700">
                  予実分析
                </a>
                <span>/</span>
                <span className="text-gray-900">詳細レポート</span>
              </nav>
